...
<form method="POST">
	<table>
		...
		<tr>
			<td>Kelas: </td>
			<td><input type="radio" name="kelas" value="MI-01">MI-01<br>
				<input type="radio" name="kelas" value="MI-02">MI-02<br>
				<input type="radio" name="kelas" value="MI-03">MI-03<br>
				<input type="radio" name="kelas" value="MI-04">MI-04</td>
		</tr>
		<tr>
			<td>Jenis Kelamin: </td>
